...
const pin_map_t pin_map_table[]=
{
    ...
    {D2, rt_pin_get("p008")};                                 /* LED_BUILTIN */
    {D3, rt_pin_get("p506")};
    {D4, rt_pin_get("p603")};
    {D5, rt_pin_get("p604")};
    {D6, rt_pin_get("p605")};
    ...
    {D11, rt_pin_get("p512"), "spi4"};                        /* SPI-MOSI */
    {D12, rt_pin_get("p511"), "spi4"};                        /* SPI-MISO */
    {D13, rt_pin_get("p204"), "spi4"};                        /* SPI-SCK */
    {D14, rt_pin_get("p203"), "i2c1"};                        /* I2C-SDA (Wire) */
    {D15, rt_pin_get("p202"), "i2c1"};                        /* I2C-SCL (Wire) */
    {A0, rt_pin_get("p000"), "adc0", 0};                      /* ADC */
    {A1, rt_pin_get("p001"), "adc0", 1};                      /* ADC */
    {A2, rt_pin_get("p002"), "adc0", 0};                      /* ADC */
    {A3, rt_pin_get("p003"), "adc0", 7};                      /* ADC */
    {A4, rt_pin_get("p508"), "adc0", 19};                     /* ADC */
